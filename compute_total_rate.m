function total_rate = compute_total_rate(e, predicted_len, total_UE, num_RB, pre_distance, rayleigh_gain, P, sigmsqr, eta, B, user_RU)
    ...
    for t = 1:predicted_len
        ...
        for n = 1:total_UE
            for k = 1:num_RB
                ...
                interference = -E(t,n,k)*P*pre_distance(t,n,user_RU(n)).^(-eta) * rayleigh_gain(n, k); % add everyone then substract myself
