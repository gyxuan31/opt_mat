...
for t = 1
    ...
    % fitnessFcn = @(e) compute_total_rate(e, predicted_len, total_UE, num_RB, pre_distance, rayleigh_gain, P, sigmsqr, eta, B, T, user_RU, num_RU);
    ...
    y = [];
    for i = 1:4
        y(i) = compute_total_rate(e_plot(i,:), predicted_len, total_UE, num_RB, pre_distance, rayleigh_gain, P, sigmsqr, eta, B, T, user_RU, num_RU)
    end
    plot(e_plot,y)
    e_opt
    for i = 1: nvars
